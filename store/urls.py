...
urlpatterns = [
    ...
    path('dashboard/apps/<slug:slug>/reset-downloads/', views.reset_downloads, name='dashboard_reset_downloads'),
    path('dashboard/reset-all-downloads/', views.reset_all_downloads, name='dashboard_reset_all_downloads'),
